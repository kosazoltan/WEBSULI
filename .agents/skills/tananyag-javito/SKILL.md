...
description: Hiányos, hibás HTML vagy Studio JSON tananyagok forráshű, mentett és ellenőrzött fúziós javítása. Aktiválódjon tananyag javítása esetén.
---

# Tananyag javítása — fúzió 7.4
...
A [futó skill-tanulási eljárás](../../../docs/runtime-skill-learning.md) is része a javításnak. A program a javító skill saját tapasztalatait tölti be, megőrzi a közben kijavított hibák bizonyítékát, és az alkalmazás visszaolvasását is utóellenőrzi. Az aktuális alkalmazás-SKILL.md az admin Futások felületéről tölthető le. Ismeretlen hiba megfigyelésként rögzül; az alapforrás, a célzott javítás hatóköre, a mentés és a minőségkapuk nem írhatók felül tanult utasítással.
...
A közös módszer 2026-09-11-es kiegészítése is kötelező: tényleges PDF/DOCX szöveg, teljes-forrás összevetés, indokolt gépi besorolás; témához illő közös geometriai labor/döntési történet HTML-ben és Studio-ban; szerveren ellenőrzött első játékbónusz-válasz és visszatérés a leckéhez. Forrásellentmondás javításánál az eredeti számok és a helyesbítés indoka is látható maradjon. Külön jelölt, lektor, teljes mentés és feltételes alkalmazás szükséges.
