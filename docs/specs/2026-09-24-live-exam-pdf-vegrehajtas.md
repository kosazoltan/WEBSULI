...
5. Kapuk: `npx tsc --noEmit`, `npx tsc -p tsconfig.test.json --noEmit`, `npx eslint client/src server --max-warnings 0`, `node --import tsx --test tests/*.test.ts`, `npm run build`.
