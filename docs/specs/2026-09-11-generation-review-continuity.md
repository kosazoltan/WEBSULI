...
A lezárt éles futás további mért hibája: a végső, elutasító lektorjelentés a külön jegyzettáblába bekerült, de a job.output.report az előző kör üres jelentése maradt; a felület általános hibaüzenetet kapott. A hibastátusszal együtt az aktuális jelentést és körszámát is el kell menteni, az üzenetben a konkrét blokkoló indokokat meg kell nevezni. Ez nem enged át hibás leckét.
...
A végső lektorjelentés regressziója szintén előbb bukott, javítás után PASS. A végleges ellenőrzés: 33/33 pipeline-teszt és 1120/1120 teljes egységteszt, 0 kihagyás; typecheck, lint és build PASS. A korai kapumérés nem tárolódik elavult végleges jelentésként. Az új teljes adatmentés izolált PostgreSQL 17 visszaállítása igazolt: 176 tananyag és 16 lecke, éles írás nélkül.
