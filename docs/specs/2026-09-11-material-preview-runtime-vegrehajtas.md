...
5. Review-kiegészítés: a dinamikus viewport a közös shell/body szintjén is érvényesüljön, 100vh fallback megtartásával. A két CSS-kompatibilitási esetet szimuláló renderpróba és mock SpeechRecognition hibateszt szükséges.
