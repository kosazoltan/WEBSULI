...
A nyílt feladat saját mintáját ugyanaz az értékelő ellenőrizze, mint a tanuló válaszát. Javításkor a modell kapja meg a konkrét fel nem ismert kötelező szinonimacsoportokat, ne csak a hiányzó csoportok számát. A rubrika őrizze a fogalom jelentését és alapformáját, de tartalmazza a mintában használt ragozott alakot is (például mag/magra, víz/vízre); a rövid szavak ragozása nem automatikusan feloldott. Hiányzó fogalom törlése és az egész mintamondat szinonimaként való megadása nem megfelelő javítás. A tanulói pontozás és a teljes bank ellenőrzése változatlan.
