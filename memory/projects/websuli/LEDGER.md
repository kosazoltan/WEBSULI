...
**Nem futtatott / nyitott:** a tulajdonosi 49 fogalmas térkép 3. futásának `done`-ja (futás közben a bejegyzés írásakor); a webes lecke pedagógiai figyelmeztetéseinek megjelenítése a Studio felületen (a `warnings` mező jelenleg csak a bizonyítékban van); üres `title` a webes jobnál (a HTML-ből jön a cím).
